...
!function(){const e=document.querySelector(".banner__container");new Swiper(e,{speed:800,loop:!0,autoplay:{delay:5e3,disableOnInteraction:!1},pagination:{el:e.querySelector(".banner__pagination"),type:"bullets",clickable:!0}})}();
!function(){const e=document.querySelector(".description__slider").querySelector(".description__swiper-container");new Swiper(e,{slidesPerView:3,spaceBetween:10,navigation:{nextEl:e.querySelector(".description__next"),prevEl:e.querySelector(".description__prev")},breakpoints:{320:{slidesPerView:1,spaceBetween:20},500:{slidesPerView:2,spaceBetween:10},600:{slidesPerView:3,spaceBetween:10}}})}();
!function(){const e=document.querySelector(".main-gallary"),i=e.querySelector(".main-gallary__container"),r=e.querySelector(".main-gallary__prev"),l=e.querySelector(".main-gallary__next");new Swiper(i,{slidesPerView:1,spaceBetween:10,navigation:{nextEl:l,prevEl:r},breakpoints:{320:{slidesPerView:3},500:{slidesPerView:4},600:{slidesPerView:5},780:{slidesPerView:3},1e3:{slidesPerView:4},1296:{slidesPerView:5}}})}();
!function(){const e=document.querySelector(".main-info__inner"),a=e.querySelector(".main-gallary"),i=e.querySelector(".main-img__image");function l(e){a.querySelector(".main-gallary__slide--active")&&a.querySelector(".main-gallary__slide--active").classList.remove("main-gallary__slide--active"),e.classList.add("main-gallary__slide--active"),i.src=e.querySelector("img").src}l(a.querySelector(".main-gallary__slide--active")),a.addEventListener("click",(function(e){if(e.target.closest(".main-gallary__slide")){l(e.target.closest(".main-gallary__slide"))}}))}();
!function(){const e=document.querySelector(".menu");e.addEventListener("click",(function(t){if(t.target.closest(".sub-menu__item")){e.querySelector(".sub-menu__title--active").classList.remove("sub-menu__title--active"),e.querySelector(".menu__title--active").classList.remove("menu__title--active");const t=document.querySelector(".header"),s=t.querySelector(".menu-btn");document.body.classList.remove("scroll"),t.classList.remove("header__shadow"),s.classList.remove("menu-btn--open"),e.classList.remove("menu__animation--open"),e.classList.add("menu__animation--close"),setTimeout(()=>{e.classList.remove("menu--open")},300)}t.target.closest(".sub-menu__title")?t.target.closest(".sub-menu__title").classList.toggle("sub-menu__title--active"):t.target.classList.contains("menu__title--active")?t.target.classList.remove("menu__title--active"):t.target.closest(".menu__title")&&(e.querySelector(".menu__title--active")&&e.querySelector(".menu__title--active").classList.remove("menu__title--active"),t.target.closest(".menu__title").classList.add("menu__title--active"))}))}();
!function(){const e=document.querySelector(".header"),s=e.querySelector(".menu"),n=e.querySelector(".menu-btn");n.addEventListener("click",(function(){s.classList.contains("menu--open")?(document.body.classList.remove("scroll"),e.classList.remove("header__shadow"),n.classList.remove("menu-btn--open"),s.classList.remove("menu__animation--open"),s.classList.add("menu__animation--close"),setTimeout(()=>{s.classList.remove("menu--open")},300)):(e.classList.add("header__shadow"),document.body.classList.add("scroll"),n.classList.add("menu-btn--open"),s.classList.add("menu--open"),setTimeout(()=>{s.classList.add("menu__animation--open"),s.classList.remove("menu__animation--close")},1))}))}();
!function(){const e=document.querySelector(".main-text"),t=[];function n(e,t){return Math.floor(Math.random()*(t-e))+e}function i(){this.basePrice=n(2e3,3e3),this.sale=n(5,20),this.size={s:this.basePrice,m:this.basePrice+50,l:this.basePrice+100,xl:this.basePrice+150,xxl:this.basePrice+200},this.discountForMore=n(30,50),this.bought=n(50,100),this.weHave=n(10,100)}for(let e=0;e<9;e++)t.push(new i);let o=t[0],r=o.size.s,c=1,u=r*c;function s(){u=r*c,e.querySelector(".main-text__price-old").innerText=u}function a(){let t;t=c>=10?Math.floor(u*((100-o.discountForMore)/100)):Math.floor(u*((100-o.sale)/100)),e.querySelector(".main-text__price-new").innerText=t}function l(){let t;t=Math.floor(r*((100-o.discountForMore)/100)),e.querySelector(".main-text__sale-size").innerText=t}function h(){let t=o.weHave-c;e.querySelector(".main-text__count-span").innerText=t}function f(){o.bought,e.querySelector(".main-text__about-count").innerText="купили более "+o.bought}function x(){s(),a(),l(),h(),f()}s(),a(),l(),h(),f(),e.querySelectorAll(".delect-color__radio").forEach((e,n)=>{e.addEventListener("input",(function(){!function(e){o=t[e],r=o.size.s,x()}(n)}))}),e.querySelector(".counter__input").addEventListener("input",(function(){c=this.value,x()}))}();
document.querySelectorAll(".swiper-box").forEach(e=>{let r=e.querySelector(".swiper-container");new Swiper(r,{navigation:{nextEl:e.querySelector(".swiper-button-next"),prevEl:e.querySelector(".swiper-button-prev")},slidesPerView:1,spaceBetween:10,breakpoints:{370:{slidesPerView:2,spaceBetween:10},590:{slidesPerView:3,spaceBetween:20},770:{slidesPerView:4,spaceBetween:20},960:{slidesPerView:5,spaceBetween:20},1150:{slidesPerView:6,spaceBetween:20}}})});
!function(){const e=document.querySelector(".main-text__counter-box"),t=e.querySelector(".counter__input");function n(e){return e>1||Number.isInteger(+e)}e.addEventListener("click",(function(e){e.target.closest(".counter__increment")&&n(t.value)&&(++t.value,t.dispatchEvent(new Event("input"))),e.target.closest(".counter__decrement")&&n(t.value)&&+t.value>1&&(--t.value,t.dispatchEvent(new Event("input")))}))}();
mediumZoom(document.querySelector(".main-img__image"),{margin:0,background:"rgba(0, 0, 0, 0.8)"});