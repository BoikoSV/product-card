...
!function(){const e=document.querySelector(".main-text__counter-box"),t=e.querySelector(".counter__input");function n(e){return e>1||Number.isInteger(+e)}e.addEventListener("click",(function(e){e.target.closest(".counter__increment")&&n(t.value)&&++t.value,e.target.closest(".counter__decrement")&&n(t.value)&&+t.value>1&&--t.value}))}();
