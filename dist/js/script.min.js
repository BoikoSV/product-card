...
!function(){const e=document.querySelector(".header"),s=e.querySelector(".menu"),n=e.querySelector(".menu-btn");n.addEventListener("click",(function(){s.classList.contains("menu--open")?(e.classList.remove("header__shadow"),n.classList.remove("menu-btn--open"),s.classList.remove("menu__animation--open"),s.classList.add("menu__animation--close"),setTimeout(()=>{s.classList.remove("menu--open")},500)):(e.classList.add("header__shadow"),n.classList.add("menu-btn--open"),s.classList.add("menu--open"),setTimeout(()=>{s.classList.add("menu__animation--open"),s.classList.remove("menu__animation--close")},1))}))}();
